...
a persistence unit "demowebPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoweb/pom.xml":
...
artifact ("demoweb.war") is already built. You can build
